...
While one can strive for perfection, it's impossible to meet this standard for data curation. An accurate database is one that is contunually updated and monitored.
